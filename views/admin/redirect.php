...
<div style="clear: both;"></div>
	...
	<div><img src="<?php echo STATIC_ROOT;?>/views/js/i/load.gif"></div>
	<div><span class="red"><?php echo $message;?></span>&nbsp;<span class="blue">
	<?php echo $time;?>秒</span>&nbsp;后自动跳转&nbsp;</div>
	<div style="padding-top: 30px;"><a href="<?php echo $url;?>"><img src="<?php echo STATIC_ROOT;?>/views/js/i/jump.gif"></a></div>
