...
<form method="post" action="index.php?step=7" id="loginform" name="loginform">
	...
	<p>
		<label>网站地址<br>
		<input type="text" tabindex="20" size="20" value="<?php echo "http://".$_SERVER ['HTTP_HOST'].str_replace("\\","",dirname(dirname($_SERVER['PHP_SELF'])));?>" class="input" id="user_pass" name="site_url"></label>
	</p>
	<p>
		<label>静态文件地址<br>
		<input type="text" tabindex="20" size="20" class="input" id="user_login" name="img_url" value="http://bidcms.jiazheng01.com/bidcmsimg/createthumb.php?bidcmskey=" ></label>
	</p>
	<p>
		<label>管理员<br>
