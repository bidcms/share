...
function() {
    ...
    function getVideoOnCustomerPage(e, t) {
        var n = function(e, n) {
            var r = new Image;
            if (e.indexOf("player.youku.com/player") > 0 || e.indexOf("www.tudou.com") > 0 || e.indexOf("player.ku6.com/refer") > 0 || e.indexOf("player.56.com") > 0) 
			r.src = "http://" + siteDomain + "/models/createimg.php?url=" + encodeURIComponent(e),
            r.width = 448,
            r.height = 336,
            ...
            t.push(r);
                ...
                if (!s) return ! 1;
                s = s[1],
                r.src = "http://" + siteDomain + "/pins/create/video/mysohu/" + s,
                r.width = 480,
                r.height = 360,
                r = encapsulateImage(r),
                r.container = n,
                ...
                if (!s) return ! 1;
                s = s[1],
                r.src = "http://" + siteDomain + "/pins/create/video/sohu/" + s,
                r.width = 480,
                r.height = 360,
                r = encapsulateImage(r),
                r.container = n,
                ...
                if (!s) return ! 1;
                s = s[1],
                r.src = "http://" + siteDomain + "/pins/create/video/ifeng/" + s,
                r.width = 480,
                r.height = 360,
                r = encapsulateImage(r),
                r.container = n,
                ...
                r.media_type = 1,
                t.push(r)
            } else if (e.indexOf("manhua1.appsina.com") > 0 || e.indexOf("weibo.vmanhua.com") > 0) r.src = "http://" + siteDomain + "/models/createimg.php?url=" + e,
            r.width = 187,
            r.height = 255,
            r = encapsulateImage(r),
            r.container = n,
            ...
            t.push(r);
                ...
                if (!s) return ! 1;
                s = s[1],
                e.indexOf("video") > 0 ? r.src = "http://" + siteDomain + "/pins/create/video/yinyuetai/" + s: r.src = "http://" + siteDomain + "/pins/create/video/yytList/" + s,
                r.width = 480,
                r.height = 360,
                r = encapsulateImage(r),
                r.container = n,
                ...
                if (!s) return ! 1;
                s = s[1],
                r.src = "http://" + siteDomain + "/pins/create/video/qiyi/" + s,
                r.width = 115,
                r.height = 77,
                r = encapsulateImage(r),
                r.container = n,
                ...
                if (!s) return ! 1;
                s = s[1],
                r.src = "http://" + siteDomain + "/pins/create/video/jfz/" + s,
                r.width = 480,
                r.height = 305,
                r = encapsulateImage(r),
                r.container = n,
                ...
                r.media_type = 1,
                t.push(r)
            } else if (e.indexOf("player.pptv.com/v") > 0) r.src = "http://" + siteDomain + "/models/createimg.php?url=" + e,
            r.width = 120,
            r.height = 60,
            r = encapsulateImage(r),
            r.container = n,
    ...
    function getCurrentPageImagesWithEncapsulation(d, eImages, opts) {
        ...
        } else if ((url.indexOf("www.iqiyi.com") > 0 || url.indexOf("yule.iqiyi.com") > 0) && info.hasOwnProperty("videoId")) thumb.src = "http://" + siteDomain + "/pins/create/video/qiyi/" + info.videoId,
        thumb.width = 115,
        thumb.height = 77,
        thumb = encapsulateImage(thumb),
        ...
        eImages.push(thumb);
            ...
            thumb.media_type = 1,
            eImages.push(thumb)
        } else if (url.indexOf("v.pptv.com/show") > 0) thumb.src = "http://" + siteDomain + "/pins/create/video/pptv/" + webcfg.id,
        thumb.width = 120,
        thumb.height = 60,
        thumb = encapsulateImage(thumb),
    ...
    function isPinable(e) {
        ...
        t = !1;
        else if (siteDomain == i) /^\/guide\/pin\/?/.test(r.pathname)||(e&&alert("你就在BidCms本站呢，不能采集本站图片。"),t=!1);else if(/ ^ 127.0.0.1( ? ::\d + ) ? /.test(i))n=!0;else if(/ ^ localhost( ? ::\d + ) ? /.test(i))n=!0;else if(/ ^ 10\. / .test(i)) n = !0;
        ...
        return n && (e && alert("你现在访问的是内部网络，不能采集内网图片。"), t = !1),
        t
    }
    function pinImage(e, t) {
        ...
        var o = e.big_img ? e.big_img: s,
        u = {
            media: e.big_img ? e.big_img.src: s.src,
            url: r,
            w: o.naturalWidth || o.width,
            h: o.naturalHeight || o.height,
            alt: s.alt,
        ...
        imageDesc && (u.description = imageDesc);
        var a = [];
        a.push(bookmarkletUrl),
        a.push("&");
        if (t && typeof t == "function") return t(u);
        for (var f in u) a.push(encodeURIComponent(f)),
        a.push("="),
        a.push(encodeURIComponent(u[f])),
        a.push("&");
        isShareBtn && a.push("is_share_btn=1&"),
        huaban_md && a.push("md=" + encodeURIComponent(huaban_md));
        var r = a.join(""),
        l = "status=no,resizable=no,scrollbars=yes,personalbar=no,directories=no,location=no,toolbar=no,menubar=no,width=632,height=320,left=0,top=0";
        window.open(r, "pin" + (new Date).getTime(), l)
    }
    function thunderpinImage(e, t, n) {
        if (Browser.ie6 || Browser.ie7) return window.alert("您的浏览器版本太低，请升级你的浏览器。");
        if (!isLogin) {
            var r = "http://" + siteDomain + "/index.php?con=ajax&act=login",
        ...
        function(r) {
            ...
            s = function(r) {
                ...
                if (r.warning == 100) {
                    ...
                    a = "你已经在画板" + r.pin.board.title + "中采集过这张图片";
                    return thunderpin_state(e, t, n, "warning", a, u)
                }
                var a = '<a href="http://' + siteDomain + "/index.php?con=pins&act=item&id=" + r.pin.pin_id + '" target="_blank;">查看采集</a>';
    ...
    function thunderpin_state(e, t, n, r, i, s) {
        ...
        if (!u) {
            ...
            if (r == "warning") {
                ...
                p.href = "javascript:;",
                p.appendChild(document.createTextNode("取消")),
                p.onclick = function() {
                    o.setAttribute("data-thunder", ""),
                    f && f.parentNode && f.parentNode.removeChild(f)
                },
                ...
                c.appendChild(h),
                c.appendChild(document.createTextNode("，或者")),
                c.appendChild(p),
                f.appendChild(c)
    ...
    function showImages(e) {
        ...
        o.href = "javascirpt:;",
        o.appendChild(document.createTextNode("取消")),
        i.appendChild(o),
        r.appendChild(i),
        ...
        function(e) {
            ...
            isIE() ? i.className = global + "Img": i.setAttribute("class", global + "Img"),
            u.setAttribute("style", "" + calculateMarginTop(e)),
            u.src = e.src,
            ...
            a.setAttribute("title", "快速采集"),
            f.setAttribute("title", "采集到BidCms"),
            a.onclick = function() {
                thunderpinImage(e, r);
                return
            },
    ...
    function initXDM() {
		 xdm = new easyXDM.Rpc({
            swf: "http://" + siteDomain + "/static/bidcms/js/xdm/easyxdm.swf",
            remote: "http://" + siteDomain + "/index.php?act=xdm",
            remoteHelper: "http://" + siteDomain + "/static/bidcms/js/xdm/name.html",
            onReady: function() {
				checkLogin()
            }
        },
    ...
    minHeight = 100,
    huaban_md = "",
    siteDomain = "bidcms.jiazheng01.com",
    imageRoot = "http://" + siteDomain + "/static/bidcms/i",
    bookmarkletUrl = "http://" + siteDomain + "/index.php?con=pins&act=bookmarket",
    analyticsUrl = "http://" + siteDomain + "/static/bidcms/js/xdm/share_analytics.html",
    xdmUrl = "http://" + siteDomain + "/static/bidcms/js/xdm/easyXDM.min.js",
    json2Url = "http://" + siteDomain + "/static/bidcms/js/json2.js",
    domChanged = !1,
    selectedText = "",
    lastScrollY = 0,
    isShareBtn = !1,
