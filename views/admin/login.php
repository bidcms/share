...
.logink{height:200px;width:470px;margin-right:auto;margin-left:auto;margin-top:170px;background-image:url(<?php echo STATIC_ROOT;?>/views/<?php echo $GLOBALS['setting']['adminpath'];?>/images/admin_img/login_bj.gif);background-repeat:no-repeat;background-position:left 25px;}
...
<form method="post" target="login" action="index.php?con=<?php echo $GLOBALS['setting']['adminpath'];?>&act=login" id="loginform" name="loginform">
	...
	<div class="dlkbt"><a href="http://www.lhaitun.com" target="_blank">BidCms图片分享购物导航管理系统</a></div>
</div>
