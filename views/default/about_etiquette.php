...
<script> var app = app || {};
app.page = app.page || {};
app.page["bidcmsurl"] = "/about/etiquette/";
app.page["title"] = "关于";
app.page["userAgent"] = "mozilla/5.0 (windows nt 6.1; wow64) applewebkit/535.11 (khtml, like gecko) chrome/17.0.963.56 safari/535.11";
app._csr = true
;var view = app.view = $("page").hide();

app.render("about/etiquette", view, function(code, html){view.show();}); </script>
